...
public class SessionFilter implements Filter {
    ...
    private final List<Pattern> urlPassPattern = Arrays.asList(
            ...
            Pattern.compile("^/course/serchCategory$"),
            
            Pattern.compile("^/course/visitorSchedule$"),

            Pattern.compile("^/course/visitorCourse$"),

            Pattern.compile("^/course/checkInPage$"),
            
            Pattern.compile("^/course/managerSchedule$"),
            
            Pattern.compile("^/course/managerScheduleEdit$"),
            
            Pattern.compile("^/course/managerCourseDetailList$"),
            
            Pattern.compile("^/course/managerCourseDetailEdit$"),
            
            Pattern.compile("^/course/managerCourseList$"),
            
            Pattern.compile("^/course/managerCourseEdit$"),

            Pattern.compile("^/course/serchCategory$"),

            Pattern.compile("^/course/createOrUpdateContent$"),

            Pattern.compile("^/course/createOrUpdateCourse$"),
            
            Pattern.compile("^/course/serchContent$"),
            
            Pattern.compile("^/course/serchCourse$"),
            
            Pattern.compile("^/course/updateRegistr$"),
            
            Pattern.compile("^/course/takeOutSingInSheet$"),
            
            Pattern.compile("^/course/checkIn$"),
            
            Pattern.compile("^/course/checkOut$"),
            
            Pattern.compile("^/course/studytime$"),
            
            Pattern.compile("^/course/createOrUpdateSchedule$"),
            
            Pattern.compile("^/course/serchSchedule$"),

            Pattern.compile("^/course/deleteSchedule$"),
